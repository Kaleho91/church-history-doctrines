...
export function FontSizeControl() {
    ...
    return (
        <button
            ...
            className="fixed bottom-6 left-6 z-10 flex items-center gap-1.5 px-3 py-2 bg-white/95 backdrop-blur-sm text-[#6b6358] rounded-full shadow-lg border border-[#e8e4dc] hover:shadow-xl transition-all text-sm font-medium"
